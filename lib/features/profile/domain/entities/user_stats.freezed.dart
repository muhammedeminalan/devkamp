...
mixin _$UserStats {
  ...
  int get hashCode => Object.hash(
      runtimeType, totalSolved, correctAnswers, streakDays, accuracy, rank);

  @override
  String toString() {
    return 'UserStats(totalSolved: $totalSolved, correctAnswers: $correctAnswers, streakDays: $streakDays, accuracy: $accuracy, rank: $rank)';
  }
}
...
extension UserStatsPatterns on UserStats {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int totalSolved, int correctAnswers, int streakDays,
            double accuracy, String rank)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserStats() when $default != null:
        return $default(_that.totalSolved, _that.correctAnswers,
            _that.streakDays, _that.accuracy, _that.rank);
      case _:
        return orElse();
    }
  }
